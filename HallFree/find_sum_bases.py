...
from HallFree.number_partition import FactorSumNumberPartition, NumberPartitionError
from HallFree.prime_utils import is_prime

def find_sum_bases(n: int, max_base: Optional[int] = None) -> List[Tuple[int, int]]:
    """
...
if __name__ == "__main__":
    ...
    if 'pytest' in sys.modules:
        pass  # pytest will discover tests if present
    else:
        main() 
