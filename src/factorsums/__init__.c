...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "factorsums.__init__",
        "sources": [
            "./src/factorsums/__init__.py"
        ]
    },
    "module_name": "factorsums.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__factorsums
#define __PYX_HAVE_API__factorsums
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "factorsums" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "factorsums.__init__"
extern int __pyx_module_is_main_factorsums____init__;
int __pyx_module_is_main_factorsums____init__ = 0;

/* Implementation of "factorsums" */
...
static const char __pyx_k_factorsums___init[] = "factorsums.__init__";
...
#define __pyx_kp_u_factorsums___init __pyx_string_tab[2]
...
static int __pyx_pymod_exec_factorsums(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_factorsums},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_factorsums(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_factorsums(); }
#endif
__Pyx_PyMODINIT_FUNC PyInit_factorsums(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_factorsums(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'factorsums' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "factorsums" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_factorsums", 0);
  ...
  if (__pyx_module_is_main_factorsums____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_factorsums___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "factorsums")) {
      if (unlikely((PyDict_SetItemString(modules, "factorsums", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init factorsums", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init factorsums");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_factorsums___init, sizeof(__pyx_k_factorsums___init), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_factorsums___init */
